...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { activity_id: @adventure.activity_id, cost_id: @adventure.cost_id, location_id: @adventure.location_id, name: @adventure.name, photo_url: @adventure.photo_url }
    end
  ...
  test "should update adventure" do
    put :update, id: @adventure, adventure: { activity_id: @adventure.activity_id, cost_id: @adventure.cost_id, location_id: @adventure.location_id, name: @adventure.name, photo_url: @adventure.photo_url }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
